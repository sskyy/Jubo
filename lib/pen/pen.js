...
(function(doc) {
  ...
  utils.merge = function(config) {
    ...
    //for menu
    if( config.menu ){
      defaults.menu = document.querySelector(config.menu)
    }
  ...
  Pen.prototype.toolbar = function() {
    ...
    var menu = this.config.menu || doc.createElement('div');
    menu.setAttribute('class', this.config.class + '-menu pen-menu');
    menu.innerHTML = icons;
    !this.config.menu && doc.body.appendChild(menu);
    this._menu = menu
